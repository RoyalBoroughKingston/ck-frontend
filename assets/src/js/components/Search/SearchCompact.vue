<template>
    <div id="compact" class="flex-container flex-container--no-padding flex-container--mobile-padding flex-container--justify">
        <div :class="layoutClass" v-for="service in services" :key="service.id">
            <service-compact :service="service" :organisation="getOrganisation(service)" :location="getLocation(service)"></service-compact>
        </div>
    </div>
</template>
...
<script>
    ...
    import ServiceCompact from '../ServiceCompact'
